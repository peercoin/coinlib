...
class TxVector({
  required var Transaction obj,
  required var String hashHex,
  String? txidHex,
  required var bool isWitness,
  required var bool isCoinBase,
  required var bool isCoinStake,
  required var bool complete,
  required var int size,
  required var List<Type> inputTypes,
  required var String hex,
  required var bool locktimeIsEnforced,
  var String? legacyHex,
}) {
  String txidHex = txidHex ?? hashHex;
}
...
final validTxVecs = [
  ...
  TxVector(
    ...
    size: 158,
    inputTypes: [P2PKHInput],
    hex: "",
  ),
  ...
  TxVector(
    ...
    size: 44,
    inputTypes: [],
    hex: "030000000001a0860100000000001976a914c42e7ef92fdb603af844d064faad95db9bcdfd3d88ac04030201",
  ),
...
class SigHashVector({
  ...
  required final String scriptCodeAsm,
  required final SigHashType type,
  required final String hash,
  required final String witnessHash,
});

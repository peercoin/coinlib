...
final class WitnessSignatureHasher(
  @override final LegacyWitnessSignDetailsWithScript details,
) extends SignatureHasher with Writable {
  static final hashZero = Uint8List(32);

  final TransactionSignatureHashes hashes = TransactionSignatureHashes(
    details.tx,
  );

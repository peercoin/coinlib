...
class P2TR extends P2Witness {
  ...
  new fromTweakedKeyX(Uint8List tweakedKeyX)
    : super.fromData(1, checkBytes(tweakedKeyX, 32));

  /// Creates a P2TR program with a given [tweakedKey].
  new fromTweakedKey(ECPublicKey tweakedKey) : super.fromData(1, tweakedKey.x);

  /// Creates a P2TR program from a [Taproot] object.
  new fromTaproot(Taproot taproot) : this.fromTweakedKey(taproot.tweakedKey);
